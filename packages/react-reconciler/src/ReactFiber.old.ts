...
function FiberNode(tag: WorkTag, pendingProps: unknown, key: null | string, mode: TypeOfMode) {
  // Instance
  this.tag = tag;
  this.key = key;
...
//    compatible.
const createFiber = function (tag: WorkTag, pendingProps: unknown, key: null | string, mode: TypeOfMode): Fiber {
...
key: null | string, pendingProps: any, owner: null | Fiber, mode: TypeOfMode, lanes: Lanes): Fiber {
...
export function createOffscreenHostContainerFiber(props: Props, fiberMode: TypeOfMode, lanes: Lanes, key: null | string): Fiber {

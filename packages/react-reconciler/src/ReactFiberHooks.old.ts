import type { MutableSource, MutableSourceGetSnapshotFn, MutableSourceSubscribeFn, ReactContext } from "shared/ReactTypes";
...
import { NoLane, SyncLane, NoLanes, isSubsetOfLanes, includesBlockingLane, mergeLanes, removeLanes, intersectLanes, isTransitionLane, markRootEntangled, markRootMutableRead, NoTimestamp } from "./ReactFiberLane.old";
...
import { getWorkInProgressRoot, scheduleUpdateOnFiber, requestUpdateLane, requestEventTime, markSkippedUpdateLanes, isInterleavedUpdate } from "./ReactFiberWorkLoop.old";
...
import { createUpdate as createLegacyQueueUpdate, enqueueUpdate as enqueueLegacyQueueUpdate, entangleTransitions as entangleLegacyQueueTransitions } from "./ReactUpdateQueue.old";
    ...
    if (!didWarnAboutMismatchedHooksForComponent.has(componentName)) {
      ...
      if (hookTypesDev !== null) {
        ...
        for (let i = 0; i <= ((hookTypesUpdateIndexDev as any) as number); i++) {
          ...
          const newHookName = i === ((hookTypesUpdateIndexDev as any) as number) ? currentHookName : oldHookName;
...
function areHookInputsEqual(nextDeps: Array<unknown>, prevDeps: Array<unknown> | null) {
  if (__DEV__) {
...
export function renderWithHooks<Props, SecondArg>(current: Fiber | null, workInProgress: Fiber, Component: (p: Props, arg: SecondArg) => any, props: Props, secondArg: SecondArg, nextRenderLanes: Lanes): any {
  ...
  if (__DEV__) {
    hookTypesDev = current !== null ? ((current._debugHookTypes as any) as Array<HookType>) : null;
...
function mountReducer<S, I, A>(reducer: (arg0: S, arg1: A) => S, initialArg: I, init?: (arg0: I) => S): [S, Dispatch<A>] {
  ...
  hook.queue = queue;
  const dispatch: Dispatch<A> = queue.dispatch = (dispatchReducerAction.bind(null, currentlyRenderingFiber, queue) as any);
  return [hook.memoizedState, dispatch];
}

function updateReducer<S, I, A>(reducer: (arg0: S, arg1: A) => S, initialArg: I, init?: (arg0: I) => S): [S, Dispatch<A>] {
...
function rerenderReducer<S, I, A>(reducer: (arg0: S, arg1: A) => S, initialArg: I, init?: (arg0: I) => S): [S, Dispatch<A>] {
  const hook = updateWorkInProgressHook();
  const queue = hook.queue;
...
type MutableSourceMemoizedState<Source, Snapshot> = {
  refs: {
    ...
    setSnapshot: (arg0: Snapshot) => void;
  };
  source: MutableSource<any>;
  subscribe: MutableSourceSubscribeFn<Source, Snapshot>;
};

function readFromUnsubscribedMutableSource<Source, Snapshot>(root: FiberRoot, source: MutableSource<Source>, getSnapshot: MutableSourceGetSnapshotFn<Source, Snapshot>): Snapshot {
  if (__DEV__) {
...
function useMutableSource<Source, Snapshot>(hook: Hook, source: MutableSource<Source>, getSnapshot: MutableSourceGetSnapshotFn<Source, Snapshot>, subscribe: MutableSourceSubscribeFn<Source, Snapshot>): Snapshot {
  ...
  const stateHook = ((workInProgressHook as any) as Hook);
  const memoizedState = ((hook.memoizedState as any) as MutableSourceMemoizedState<Source, Snapshot>);
  ...
  hook.memoizedState = ({
    ...
    source,
    subscribe
  } as MutableSourceMemoizedState<Source, Snapshot>);
  ...
  if (!is(prevGetSnapshot, getSnapshot) || !is(prevSource, source) || !is(prevSubscribe, subscribe)) {
    ...
    newQueue.dispatch = setSnapshot = (dispatchSetState.bind(null, currentlyRenderingFiber, newQueue) as any);
...
function mountSyncExternalStore<T>(subscribe: (arg0: () => void) => () => void, getSnapshot: () => T, getServerSnapshot?: () => T): T {
  const fiber = currentlyRenderingFiber;
  const hook = mountWorkInProgressHook();
  let nextSnapshot;
...
function updateSyncExternalStore<T>(subscribe: (arg0: () => void) => () => void, getSnapshot: () => T, getServerSnapshot?: () => T): T {
  const fiber = currentlyRenderingFiber;
  const hook = updateWorkInProgressHook();
  // Read the current snapshot from the store on every render. This breaks the
  // normal rules of React, and only works because store updates are
...
function updateStoreInstance<T>(fiber: Fiber, inst: StoreInstance<T>, nextSnapshot: T, getSnapshot: () => T) {
...
function mountEffect(create: () => (() => void) | void, deps: Array<unknown> | void | null): void {
...
function updateEffect(create: () => (() => void) | void, deps: Array<unknown> | void | null): void {
  return updateEffectImpl(PassiveEffect, HookPassive, create, deps);
}

function mountInsertionEffect(create: () => (() => void) | void, deps: Array<unknown> | void | null): void {
  return mountEffectImpl(UpdateEffect, HookInsertion, create, deps);
}

function updateInsertionEffect(create: () => (() => void) | void, deps: Array<unknown> | void | null): void {
  return updateEffectImpl(UpdateEffect, HookInsertion, create, deps);
}

function mountLayoutEffect(create: () => (() => void) | void, deps: Array<unknown> | void | null): void {
...
function updateLayoutEffect(create: () => (() => void) | void, deps: Array<unknown> | void | null): void {
  return updateEffectImpl(UpdateEffect, HookLayout, create, deps);
}

function imperativeHandleEffect<T>(create: () => T, ref: {
  current: T | null;
} | ((inst: T | null) => unknown) | null | void) {
...
function mountDebugValue<T>(value: T, formatterFn: ((value: T) => unknown) | null | undefined): void {// This hook is normally a no-op.
...
function mountTransition(): [boolean, (arg0: () => void) => void] {
...
function updateTransition(): [boolean, (arg0: () => void) => void] {
...
function rerenderTransition(): [boolean, (arg0: () => void) => void] {
...
function refreshCache<T>(fiber: Fiber, seedKey: (() => T) | null | undefined, seedValue: T) {
  if (!enableCache) {
    return;
  }
...
if (enableCache) {
  (ContextOnlyDispatcher as Dispatcher).getCacheSignal = getCacheSignal;
  (ContextOnlyDispatcher as Dispatcher).getCacheForType = getCacheForType;
...
if (enableCache) {
  (HooksDispatcherOnMount as Dispatcher).getCacheSignal = getCacheSignal;
  (HooksDispatcherOnMount as Dispatcher).getCacheForType = getCacheForType;
...
if (enableCache) {
  (HooksDispatcherOnUpdate as Dispatcher).getCacheSignal = getCacheSignal;
  (HooksDispatcherOnUpdate as Dispatcher).getCacheForType = getCacheForType;
...
if (enableCache) {
  (HooksDispatcherOnRerender as Dispatcher).getCacheSignal = getCacheSignal;
  (HooksDispatcherOnRerender as Dispatcher).getCacheForType = getCacheForType;
...
if (__DEV__) {
  ...
  if (enableCache) {
    (HooksDispatcherOnMountInDEV as Dispatcher).getCacheSignal = getCacheSignal;
    (HooksDispatcherOnMountInDEV as Dispatcher).getCacheForType = getCacheForType;

    (HooksDispatcherOnMountInDEV as Dispatcher).useCacheRefresh = function useCacheRefresh() {
  ...
  if (enableCache) {
    (HooksDispatcherOnMountWithHookTypesInDEV as Dispatcher).getCacheSignal = getCacheSignal;
    (HooksDispatcherOnMountWithHookTypesInDEV as Dispatcher).getCacheForType = getCacheForType;

    (HooksDispatcherOnMountWithHookTypesInDEV as Dispatcher).useCacheRefresh = function useCacheRefresh() {
      currentHookNameInDev = 'useCacheRefresh';
      updateHookTypesDev();
      return mountRefresh();
    };
  ...
  if (enableCache) {
    (HooksDispatcherOnUpdateInDEV as Dispatcher).getCacheSignal = getCacheSignal;
    (HooksDispatcherOnUpdateInDEV as Dispatcher).getCacheForType = getCacheForType;

    (HooksDispatcherOnUpdateInDEV as Dispatcher).useCacheRefresh = function useCacheRefresh() {
      currentHookNameInDev = 'useCacheRefresh';
      updateHookTypesDev();
  ...
  if (enableCache) {
    (HooksDispatcherOnRerenderInDEV as Dispatcher).getCacheSignal = getCacheSignal;
    (HooksDispatcherOnRerenderInDEV as Dispatcher).getCacheForType = getCacheForType;

    (HooksDispatcherOnRerenderInDEV as Dispatcher).useCacheRefresh = function useCacheRefresh() {
      currentHookNameInDev = 'useCacheRefresh';
      updateHookTypesDev();
      return updateRefresh();
    };
  ...
  if (enableCache) {
    (InvalidNestedHooksDispatcherOnMountInDEV as Dispatcher).getCacheSignal = getCacheSignal;
    (InvalidNestedHooksDispatcherOnMountInDEV as Dispatcher).getCacheForType = getCacheForType;

    (InvalidNestedHooksDispatcherOnMountInDEV as Dispatcher).useCacheRefresh = function useCacheRefresh() {
      currentHookNameInDev = 'useCacheRefresh';
      updateHookTypesDev();
      return mountRefresh();
    };
  ...
  if (enableCache) {
    (InvalidNestedHooksDispatcherOnUpdateInDEV as Dispatcher).getCacheSignal = getCacheSignal;
    (InvalidNestedHooksDispatcherOnUpdateInDEV as Dispatcher).getCacheForType = getCacheForType;

    (InvalidNestedHooksDispatcherOnUpdateInDEV as Dispatcher).useCacheRefresh = function useCacheRefresh() {
      currentHookNameInDev = 'useCacheRefresh';
      updateHookTypesDev();
      return updateRefresh();
    };
  ...
  if (enableCache) {
    (InvalidNestedHooksDispatcherOnRerenderInDEV as Dispatcher).getCacheSignal = getCacheSignal;
    (InvalidNestedHooksDispatcherOnRerenderInDEV as Dispatcher).getCacheForType = getCacheForType;

    (InvalidNestedHooksDispatcherOnRerenderInDEV as Dispatcher).useCacheRefresh = function useCacheRefresh() {
      currentHookNameInDev = 'useCacheRefresh';
      updateHookTypesDev();
      return updateRefresh();
    };

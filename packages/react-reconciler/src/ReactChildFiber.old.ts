...
let warnForMissingKey = (child: unknown, returnFiber: Fiber) => {};
...
if (__DEV__) {
  ...
  warnForMissingKey = (child: unknown, returnFiber: Fiber) => {
...
function throwOnInvalidObjectType(returnFiber: Fiber, newChild: Record<string, any>) {
...
function ChildReconciler(shouldTrackSideEffects) {
  ...
  function updateFragment(returnFiber: Fiber, current: Fiber | null, fragment: Iterable<any>, lanes: Lanes, key: null | string): Fiber {
   ...
   */
  function warnOnInvalidKey(child: unknown, knownKeys: Set<string> | null, returnFiber: Fiber): Set<string> | null {
    if (__DEV__) {
  ...
  function reconcileChildrenArray(returnFiber: Fiber, currentFirstChild: Fiber | null, newChildren: Array<any>, lanes: Lanes): Fiber | null {
  ...
  function reconcileChildrenIterator(returnFiber: Fiber, currentFirstChild: Fiber | null, newChildrenIterable: Iterable<any>, lanes: Lanes): Fiber | null {

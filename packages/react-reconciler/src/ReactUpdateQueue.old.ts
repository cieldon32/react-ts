...
export function entangleTransitions(root: FiberRoot, fiber: Fiber, lane: Lane) {
  ...
  const sharedQueue: SharedQueue<unknown> = (updateQueue as any).shared;
...
export function enqueueCapturedUpdate<State>(workInProgress: Fiber, capturedUpdate: Update<State>) {
...
export function commitUpdateQueue<State>(finishedWork: Fiber, finishedQueue: UpdateQueue<State>, instance: any): void {
  // Commit the effects

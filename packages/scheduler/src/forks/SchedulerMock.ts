...
let scheduledCallback: ((arg0: boolean, arg1: number) => void) | null = null;
let scheduledTimeout: ((arg0: number) => void) | null = null;
let timeoutTime: number = -1;
let yieldedValues: Array<unknown> | null = null;
...
function requestHostCallback(callback: (arg0: boolean) => void) {
  scheduledCallback = callback;
}

function requestHostTimeout(callback: (arg0: number) => void, ms: number) {
...
function unstable_clearYields(): Array<unknown> {
...
function unstable_yieldValue(value: unknown): void {

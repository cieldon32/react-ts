...
export function useEffect(create: () => (() => void) | void, deps: Array<unknown> | void | null): void {
  const dispatcher = resolveDispatcher();
  return dispatcher.useEffect(create, deps);
}
export function useInsertionEffect(create: () => (() => void) | void, deps: Array<unknown> | void | null): void {
  const dispatcher = resolveDispatcher();
  return dispatcher.useInsertionEffect(create, deps);
}
export function useLayoutEffect(create: () => (() => void) | void, deps: Array<unknown> | void | null): void {
  const dispatcher = resolveDispatcher();
  return dispatcher.useLayoutEffect(create, deps);
}
export function useCallback<T>(callback: T, deps: Array<unknown> | void | null): T {
  const dispatcher = resolveDispatcher();
  return dispatcher.useCallback(callback, deps);
}
export function useMemo<T>(create: () => T, deps: Array<unknown> | void | null): T {
  const dispatcher = resolveDispatcher();
...
export function useDebugValue<T>(value: T, formatterFn: ((value: T) => unknown) | null | undefined): void {
  if (__DEV__) {
    const dispatcher = resolveDispatcher();
...
export function useMutableSource<Source, Snapshot>(source: MutableSource<Source>, getSnapshot: MutableSourceGetSnapshotFn<Source, Snapshot>, subscribe: MutableSourceSubscribeFn<Source, Snapshot>): Snapshot {
  const dispatcher = resolveDispatcher();
...
export function useCacheRefresh(): <T>(arg0: (() => T) | null | undefined, arg1: T | null | undefined) => void {
  const dispatcher = resolveDispatcher();
  // $FlowFixMe This is unstable, thus optional

...
import type { BoundingRect, IntersectionObserverOptions, ObserveVisibleRectsCallback } from "react-reconciler/src/ReactTestSelectors";
...
export function beforeActiveInstanceBlur(internalInstanceHandle: Record<string, any>): void {
  if (enableCreateEventHandleAPI) {
...
export function createInstance(type: string, props: Props, rootContainerInstance: Container, hostContext: HostContext, internalInstanceHandle: Record<string, any>): Instance {
...
export function prepareUpdate(domElement: Instance, type: string, oldProps: Props, newProps: Props, rootContainerInstance: Container, hostContext: HostContext): null | Array<unknown> {
  if (__DEV__) {
    const hostContextDev = ((hostContext as any) as HostContextDev);
...
export function createTextInstance(text: string, rootContainerInstance: Container, hostContext: HostContext, internalInstanceHandle: Record<string, any>): TextInstance {
  if (__DEV__) {
    const hostContextDev = ((hostContext as any) as HostContextDev);
...
export function commitMount(domElement: Instance, type: string, newProps: Props, internalInstanceHandle: Record<string, any>): void {
...
export function commitUpdate(domElement: Instance, updatePayload: Array<unknown>, type: string, oldProps: Props, newProps: Props, internalInstanceHandle: Record<string, any>): void {
...
function dispatchBeforeDetachedBlur(target: HTMLElement, internalInstanceHandle: Record<string, any>): void {
  if (enableCreateEventHandleAPI) {
...
export function canHydrateInstance(instance: HydratableInstance, type: string, props: Props): null | Instance {
...
export function canHydrateTextInstance(instance: HydratableInstance, text: string): null | TextInstance {
...
export function canHydrateSuspenseInstance(instance: HydratableInstance): null | SuspenseInstance {
...
export function hydrateInstance(instance: Instance, type: string, props: Props, rootContainerInstance: Container, hostContext: HostContext, internalInstanceHandle: Record<string, any>): null | Array<unknown> {
...
export function hydrateTextInstance(textInstance: TextInstance, text: string, internalInstanceHandle: Record<string, any>): boolean {
  precacheFiberNode(internalInstanceHandle, textInstance);
  return diffHydratedText(textInstance, text);
}
export function hydrateSuspenseInstance(suspenseInstance: SuspenseInstance, internalInstanceHandle: Record<string, any>) {
...
export function didNotMatchHydratedContainerTextInstance(parentContainer: Container, textInstance: TextInstance, text: string) {
  if (__DEV__) {
    warnForUnmatchedText(textInstance, text);
  }
}
export function didNotMatchHydratedTextInstance(parentType: string, parentProps: Props, parentInstance: Instance, textInstance: TextInstance, text: string) {
...
export function didNotHydrateInstance(parentType: string, parentProps: Props, parentInstance: Instance, instance: HydratableInstance) {
  if (__DEV__ && parentProps[SUPPRESS_HYDRATION_WARNING] !== true) {
    if (instance.nodeType === ELEMENT_NODE) {
...
export function didNotFindHydratableInstance(parentType: string, parentProps: Props, parentInstance: Instance, type: string, props: Props) {
  if (__DEV__ && parentProps[SUPPRESS_HYDRATION_WARNING] !== true) {
    warnForInsertedHydratedElement(parentInstance, type, props);
  }
}
export function didNotFindHydratableTextInstance(parentType: string, parentProps: Props, parentInstance: Instance, text: string) {
  if (__DEV__ && parentProps[SUPPRESS_HYDRATION_WARNING] !== true) {
...
export function prepareScopeUpdate(scopeInstance: ReactScopeInstance, internalInstanceHandle: Record<string, any>): void {
  if (enableScopeAPI) {

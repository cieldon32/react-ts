...
if (__DEV__) {
  ...
  normalizeMarkupForTextOrAttribute = function (markup: unknown): string {
    ...
    const markupString = typeof markup === 'string' ? markup : '' + (markup as any);
  ...
  warnForPropDifference = function (propName: string, serverValue: unknown, clientValue: unknown) {
    if (didWarnInvalidHydration) {
      return;
    }
  ...
  normalizeHTML = function (parent: Element, html: string) {
    ...
    const testElement = parent.namespaceURI === HTML_NAMESPACE ? parent.ownerDocument.createElement(parent.tagName) : parent.ownerDocument.createElementNS((parent.namespaceURI as any), parent.tagName);
...
function setInitialDOMProperties(tag: string, domElement: Element, rootContainerElement: Element | Document, nextProps: Record<string, any>, isCustomComponentTag: boolean): void {
...
export function createElement(type: string, props: Record<string, any>, rootContainerElement: Element | Document, parentNamespace: string): Element {
...
export function setInitialProperties(domElement: Element, tag: string, rawProps: Record<string, any>, rootContainerElement: Element | Document): void {
...
export function diffProperties(domElement: Element, tag: string, lastRawProps: Record<string, any>, nextRawProps: Record<string, any>, rootContainerElement: Element | Document): null | Array<unknown> {
  if (__DEV__) {
...
// Apply the diff.
export function updateProperties(domElement: Element, updatePayload: Array<any>, tag: string, lastRawProps: Record<string, any>, nextRawProps: Record<string, any>): void {
...
export function diffHydratedProperties(domElement: Element, tag: string, rawProps: Record<string, any>, parentNamespace: string, rootContainerElement: Element | Document): null | Array<unknown> {
  let isCustomComponentTag;
...
export function warnForInsertedHydratedElement(parentNode: Element | Document, tag: string, props: Record<string, any>) {
  if (__DEV__) {
    if (didWarnInvalidHydration) {
      return;
    }

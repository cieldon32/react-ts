...
export function initWrapperState(element: Element, props: Record<string, any>) {
  if (__DEV__) {
...
export function updateChecked(element: Element, props: Record<string, any>) {
  const node = ((element as any) as InputWithWrapperState);
  const checked = props.checked;
...
export function updateWrapper(element: Element, props: Record<string, any>) {
  const node = ((element as any) as InputWithWrapperState);
...
export function postMountWrapper(element: Element, props: Record<string, any>, isHydrating: boolean) {
  const node = ((element as any) as InputWithWrapperState);
...
export function restoreControlledState(element: Element, props: Record<string, any>) {
  const node = ((element as any) as InputWithWrapperState);
...
export function setDefaultValue(node: InputWithWrapperState, type: string | null | undefined, value: any) {
